...
static void storage_load(void) {
    ...
    if (newest != NULL) {
        ...
        current_settings.deep_tol_m = DEEP_TOL_M;
        current_settings.shallow_target_m = 0.55f;
        current_settings.shallow_tol_m = SHALLOW_TOL_M;
        current_settings.num_profiles = 2;
        current_settings.company_number = 14;
