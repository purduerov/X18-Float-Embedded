...
class BuoyancySimulator:
    ...
    def __init__(self, mass_g=3489, diameter_in=4.5, length_in=12, additional_volume_in3=19.311, syringe_ml=90, pool_depth_ft=15,
                 neutral_adc=1850, act_min=126, act_max=3900,
    ...
    def reset(self, initial_depth=0.0):
        ...
        # Hardcode parameters per user request to keep sim and float in sync
        self.neutral_adc = 1850
        self.mass = 3.47876  # 3478.8 grams
        self.act_min = 126
        self.act_max = 3900
